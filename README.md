...
> Initial code frok from [May](https://github.com/Xudong-Huang/may) and we add Many improvements(Inspired by ```Golang``` and [crossbeam](https://github.com/crossbeam-rs/crossbeam)) and [hyper](https://github.com/hyperium/hyper) and more...
...
* ``` cogo/std/sync ```  Includes basic Mutex/RwLock/WaitGroup/Semphore/channel(Bounded, unbounded, chan!())...and more..
